...
import { ProductItem, AdminOrder } from '@/context/DataContext';
    ...
    <>
      ...
      <div className="bg-white shadow-xl shadow-amber-950/5 rounded-3xl p-6 sm:p-8 border border-amber-900/10 space-y-6">
        ...
        <div className="h-64 w-full pt-4">
          <div className="h-full w-full flex items-end justify-between gap-2 sm:gap-6 border-b border-stone-200 pb-2">
            {(
              chartTimeframe === '7d'
                ? [
