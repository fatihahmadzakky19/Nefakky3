    ...
    <div className="min-h-screen bg-[#FBF9F5] text-[#1B1C1A] font-sans selection:bg-[#934B19]/10 selection:text-[#934B19] pb-28 lg:pb-12">
      ...
      {(confirmedSuccessMessage || addressNoticeMessage) && (
        <div className="max-w-7xl mx-auto px-4 sm:px-12 pt-6">
          <div className="bg-emerald-600 text-white px-5 py-3.5 sm:px-6 sm:py-4 rounded-2xl shadow-xl flex items-center justify-between gap-4 animate-bounce border border-emerald-500">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 py-6 sm:py-8 space-y-6 sm:space-y-8">
        
        {/* TOP PROFILE BANNER CARD */}
        <div className="bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative overflow-hidden border border-amber-900/10 shadow-xl shadow-amber-950/5">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6 text-center sm:text-left w-full md:w-auto relative z-10">
            
            {/* Avatar with Edit Pencil Overlay */}
            <div 
              className="relative w-20 h-20 sm:w-28 sm:h-28 rounded-2xl sm:rounded-3xl overflow-hidden border-2 border-amber-900/10 shadow-lg shrink-0 bg-[#3C2A21] group cursor-pointer"
            ...
            >
              ...
              <button 
                ...
                className="absolute bottom-1.5 right-1.5 sm:bottom-2 sm:right-2 p-1.5 sm:p-2 bg-[#25160E] hover:bg-[#3C2A21] text-amber-300 rounded-lg sm:rounded-xl shadow-md transition-all border border-amber-900/20 active:scale-95"
            ...
            <div className="space-y-1.5 sm:space-y-2">
              <div className="flex items-center gap-2 justify-center sm:justify-start flex-wrap">
                <h1 className="font-serif text-2xl sm:text-3xl font-bold text-[#25160E]">
                  {displayName}
                </h1>
                {user.authProvider === 'google' && (
                  <span className="px-2.5 py-0.5 sm:py-1 bg-blue-50 border border-blue-200 text-blue-700 rounded-full text-[9px] sm:text-[10px] font-bold inline-flex items-center gap-1">
              ...
              <div className="pt-2 flex items-center gap-2 sm:gap-3 flex-wrap justify-center sm:justify-start">
                <button
                  onClick={() => setIsEditingModal(true)}
                  className="px-4 py-2 sm:px-5 sm:py-2.5 bg-[#25160E] hover:bg-[#3C2A21] text-white text-xs font-bold rounded-xl sm:rounded-2xl shadow-md transition-all uppercase tracking-wider active:scale-95"
                >
                  Edit Profil
                </button>
                {(user.role === 'admin' || user.email === 'fatihahmadzakky19@gmail.com') && (
                  <Link
                    href="/admin"
                    className="px-4 py-2 sm:px-5 sm:py-2.5 bg-[#934B19] hover:bg-[#783603] text-white text-xs font-bold rounded-xl sm:rounded-2xl shadow-md transition-all flex items-center gap-2 active:scale-95"
                  >
