...
export default function MenuCatalogPage() {
  ...
  const filteredProducts = products.filter(product => {
    ...
    return matchCategory && matchSearch && product.visibility !== false;
  }).sort((a, b) => {
  ...
  return (
    <div className="min-h-screen bg-[#FBF9F5] text-[#1B1C1A] font-sans selection:bg-[#934B19]/10 selection:text-[#934B19]">
      ...
      <section className="bg-[#25160E] text-white py-12 px-6 sm:px-12 relative overflow-hidden">
        <div className="max-w-7xl mx-auto space-y-3 relative z-10 text-center sm:text-left">
          <span className="px-3.5 py-1 bg-[#934B19] text-[#FBF9F5] text-xs font-bold rounded-full uppercase tracking-wider inline-block">
            Kolesi Hidangan Utama
          </span>
          <h1 className="font-serif text-3xl sm:text-5xl font-bold tracking-tight text-[#FBF9F5]">
      ...
      <main className="max-w-7xl mx-auto px-6 sm:px-12 py-10 space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4 bg-white p-4 sm:p-5 rounded-3xl border border-amber-900/10 shadow-xl shadow-amber-950/5">
          ...
          <div className="flex items-center gap-3 self-end sm:self-auto">
            <SlidersHorizontal className="w-4 h-4 text-[#934B19]" />
            <select
              value={sortBy}
